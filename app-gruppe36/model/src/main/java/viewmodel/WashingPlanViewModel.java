...
/**
 * The `WashingPlanViewModel` class in Java represents the view model for a
 * washing
 * plan application, providing methods to manage tasks, persons, weeks, and
 * generate
 * washing plans.
 */
public class WashingPlanViewModel {
    ...
    /**
     * The function `getInstance` returns a singleton instance of
     * `WashingPlanViewModel`.
     *
    ...
    /**
     * The `addTask` function checks if the input task is null or empty, creates a
     * new Task
     * object, adds it to the washing plan model, and updates the washing plan
     * tasks.
     *
     * @param task The `addTask` method takes a `String` parameter named `task`,
     *             which
     *             represents the task to be added to the washing plan. If the
     *             `task` parameter is
     *             `null` or an empty string, the method prints a message indicating
     *             that the task
     ...
     *
     * @param person The `addPerson` method takes a `String` parameter named
     *               `person`,
     *               which represents the name of a person to be added to a washing
     *               plan. If the `person` parameter
     *               is `null` or an empty string, a message "Person field is null
     *               or empty" is printed to the
     */
    ...
    /**
     * The `updateWashingPlans` method clears the existing washing plan entries,
    ...
    /**
     * This function retrieves the washing plan entries for the current week from a
     * washing plan model.
     *
     * @return The method `getWashingPlanEntries()` returns an `ObservableList` of
     *         `WashingPlanEntry`
     *         objects.
     */
    ...
    /**
     * The function `setStartWeek` sets the start week based on the input string
     * after
     * validating it as an integer.
     *
     * @param toWeekInput The `toWeekInput` parameter is a String representing the
     *                    week
    ...
    /**
     * The function `setEndWeek` sets the end week value based on the input string
     * after
     * validating it as an integer.
     *
     * @param toWeekInput The `toWeekInput` parameter is a String representing the
     ...
     *
     * @param input The `isInteger` method checks if a given input string can be
     *              parsed into an
     *              integer. If the input can be successfully parsed without
     *              throwing a `NumberFormatException`,
     *              the method returns `true`, indicating that the input is an
     *              integer. Otherwise, it returns
     *              `false`.
     *
     * @return The method `isInteger` returns a boolean value - `true` if the input
     *         string can
     *         be parsed into an integer using `Integer.parseInt`, and `false` if a
    ...
    /**
     * The `reset` function clears lists of persons and tasks, resets the current
     * week to 1,
