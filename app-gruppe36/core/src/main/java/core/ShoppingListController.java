 ...
 * through the `HouseController` class and storing data using a `JsonFileManager`.
 */
public class ShoppingListController {
    ...
    /**
     * The getInstance method ensures that only one instance of ShoppingListController is created and
     * returned.
     *
    ...
    /**
     * This Java function adds a new item to a house's shopping list, updating the item count if the
     * item already exists in the list.
     *
     * @param newItem The `newItem` parameter is an object of type `Item` that represents the item 
     * to be added to the shopping list of a house in the system. It contains information such as the
     * item's name and count.
     *
     * @param id The `id` parameter in the `addItem` method is used to identify the specific House to
     * which the new item will be added. It is used to retrieve the House object from the controller
    ...
    /**
     * This Java function removes items from a house's shopping list based on their item names and then
     * stores the updated list to a file.
     *
     * @param items A list of items that need to be removed from the shopping list of the house.
     *
     * @param id The `id` parameter in the `removeItem` method is a unique identifier that is used to
     * connect the house to a REST API. It is used to retrieve the specific house object from the
     ...
     * @param id The `id` parameter is a unique identifier that is used to connect to a 
     * specific house in the REST API. It is used to retrieve the house object and perform 
     * operations related to that specific house, such as updating its shopping list history 
     * with new items.
