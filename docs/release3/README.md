...
Fram til siste versjon av prosjektet ble alle enhets- og integrasjonstester kjørt i pipeline. Mot slutten av prosjektet oppsto det imidlertid problemer mellom testavhengighetene og docker-imaget som ble brukt. Derfor fjernet vi teststeget i pipelinen og fokuserte i stedet på installasjon, bygging og kompilering i docker-miljøet. CI-pipelinen har vært en viktig kilde til verdifull feilsøkingsinformasjon gjennom hele prosjektet og har bidratt betydelig til kvaliteten på sluttresultatet både før, men også etter vi fjenet testing.
